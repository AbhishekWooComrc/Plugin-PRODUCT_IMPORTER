...
if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
	...
	echo '<div class="error"><p><strong>' . sprintf( esc_html__( ' Product Importer Extension installed required (Woo Commerce plugin should have installed) . You can download %s here.', 'ced-product-importer' ), '<a href="https://wordpress.org/plugins/woocommerce/" target="_blank">WooCommerce</a>' ) . '</strong></p></div>';
	} );
}
